...
function (_Component) {
  ...
  function Slider(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "setHandleRef", function (handle) {
      return _this.setState({
        handle: handle
      });
    });

    _defineProperty(_assertThisInitialized(_this), "setRailRef", function (rail) {
      return _this.setState({
        rail: rail
      });
    });

    _defineProperty(_assertThisInitialized(_this), "setSliderRef", function (slider) {
      return _this.setState({
        slider: slider
      });
    });

    _defineProperty(_assertThisInitialized(_this), "setLeftArrowRef", function (leftArrow) {
      return _this.setState({
        leftArrow: leftArrow
      });
    });

    _defineProperty(_assertThisInitialized(_this), "setRightArrowRef", function (rightArrow) {
      return _this.setState({
    ...
    _defineProperty(_assertThisInitialized(_this), "getValues", function () {
      ...
      var _this$state = _this.state,
          ...
          state = _this$state.state; // if the user has provided an onDrag handler, then we use the
